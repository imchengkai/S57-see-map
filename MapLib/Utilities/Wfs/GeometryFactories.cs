...
namespace EasyMap.Utilities.Wfs
{
    ...
    internal abstract class GeometryFactory : IDisposable
    {
        ...
        /// derived from <see cref="EasyMap.Geometries.Geometry"/>.
        /// </summary>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="EasyMap.Geometries.Point"/>.
    ...
    internal class PointFactory : GeometryFactory
    {
        ...
        /// <summary>
        /// This method produces instances of type <see cref="EasyMap.Geometries.Point"/>.
        /// </summary>
        /// <returns>The created geometries</returns>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="EasyMap.Geometries.LineString"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    internal class LineStringFactory : GeometryFactory
    {
        ...
        /// <summary>
        /// This method produces instances of type <see cref="EasyMap.Geometries.LineString"/>.
        /// </summary>
        /// <returns>The created geometries</returns>
        internal override Collection<Geometry> createGeometries()
        {
    ...
    /// <summary>
    /// This class produces instances of type <see cref="EasyMap.Geometries.Polygon"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="EasyMap.Geometries.MultiPoint"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    internal class MultiPointFactory : GeometryFactory
    {
        ...
        /// <summary>
        /// This method produces instances of type <see cref="EasyMap.Geometries.MultiPoint"/>.
        /// </summary>
        /// <returns>The created geometries</returns>
        internal override Collection<Geometry> createGeometries()
        {
    ...
    /// <summary>
    /// This class produces objects of type <see cref="EasyMap.Geometries.MultiLineString"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="EasyMap.Geometries.MultiPolygon"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
