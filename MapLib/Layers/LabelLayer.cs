...
using Transform = EasyMap.Utilities.Transform;
...
namespace EasyMap.Layers
{
    ...
    public class LabelLayer : Layer, IDisposable
    {
        ...
        /// </summary>
        /// <remarks>
        /// Default method is <see cref="EasyMap.Rendering.LabelCollisionDetection.SimpleCollisionDetection"/>
        /// </remarks>
        ...
        /// <para>The label delegate must take a <see cref="EasyMap.Data.FeatureDataRow"/> and return a string.</para>
        /// <example>
        ...
        /// <para>The label delegate must take a <see cref="EasyMap.Data.FeatureDataRow"/> and return a SharpMap.Geometries.Point.</para>
        ...
        /// <para>The label delegate must take a <see cref="EasyMap.Data.FeatureDataRow"/> and return an Int32.</para>
        /// <example>
